...
#pragma warning disable CS0414, CS0169, IDE0044 // field usage and readonly
			...
			[Field.Range(1, 60)]
			[Options.Slider(defaultValue: Mod.Consts.isGameSN? 18: 22, minValue: 10, maxValue: 40)]
			public int fontSize = Mod.Consts.isGameSN? 18: 22;
			...
			[Options.ChoiceMaster(0, nameof(messageSpacing), 10f, nameof(textLineSpacing), Mod.Consts.isGameSN? 1.2f: 21.79f)]
			[Options.ChoiceMaster(1, nameof(messageSpacing),  0f, nameof(textLineSpacing), Mod.Consts.isGameSN? 0.9f: 0f)]
			[Options.ChoiceMaster(2, nameof(messageSpacing), -5f, nameof(textLineSpacing), Mod.Consts.isGameSN? 0.75f: -20f)]
			...
			[Options.Field("Spacing between lines", "Spacing between lines in multiline messages" + (Mod.Consts.isGameSN? " (a value of 1 will produce normal line spacing)": ""))]
			[Field.Range(Mod.Consts.isGameSN? 0f: -50f, Mod.Consts.isGameSN? 2f: 200f)]
			[Options.Hideable(typeof(DetailedSetting))]
			[Options.Slider(defaultValue: Mod.Consts.isGameSN? 1.2f: 21.79f, minValue: Mod.Consts.isGameSN? 0.5f: -20f, maxValue: Mod.Consts.isGameSN? 1.5f: 50f, valueFormat: "{0:F2}")]
			public float textLineSpacing = Mod.Consts.isGameSN? 1.2f: 21.79f;
