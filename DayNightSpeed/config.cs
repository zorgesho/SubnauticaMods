...
namespace DayNightSpeed
{
	...
	class ModConfig: Config
	{
		...
		[Field.Bounds(Min:0.01f)] public readonly float speedHungerThrist   = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedPlantsGrow     = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedEggsHatching   = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedCreaturesGrow  = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedMedkitInterval = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedPowerCharge    = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float speedPowerConsume   = 1.0f;

		// obsolete inverted multipliers (v1.0.0)
#pragma warning disable CS0414 // unused field
		[Field.LoadOnly] [Field.Bounds(Min:0.01f)] readonly float multHungerThrist   = 1.0f;
		[Field.LoadOnly] [Field.Bounds(Min:0.01f)] readonly float multPlantsGrow     = 1.0f;
		[Field.LoadOnly] [Field.Bounds(Min:0.01f)] readonly float multEggsHatching   = 1.0f;
		[Field.LoadOnly] [Field.Bounds(Min:0.01f)] readonly float multCreaturesGrow  = 1.0f;
		[Field.LoadOnly] [Field.Bounds(Min:0.01f)] readonly float multMedkitInterval = 1.0f;
