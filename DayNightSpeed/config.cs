...
namespace DayNightSpeed
{
	...
	class ModConfig: Config
	{
		...
		[Field.Bounds(Min:0.01f)] public readonly float multHungerThrist   = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float multPlantsGrow     = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float multEggsHatching   = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float multCreaturesGrow  = 1.0f;
		[Field.Bounds(Min:0.01f)] public readonly float multMedkitInterval = 1.0f;
