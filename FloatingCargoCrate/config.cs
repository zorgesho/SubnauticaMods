...
namespace FloatingCargoCrate
{
	...
	class ModConfig: Config
	{
		...
		[Field.BindConsole.Skip] public readonly bool cheapBlueprint = true;
		[Field.BindConsole.Skip] public readonly bool experimentalFeaturesOn = true;
