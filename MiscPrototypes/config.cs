...
//#define TEST_CONFIG // master switch
...
namespace MiscPrototypes
{
	...
	#region Config test stuff
#if TEST_CONFIG
	public static partial class Main
	{
		internal static readonly TestConfig testConfig =
			Config.tryLoad<TestConfig>("test_config.json", Config.LoadOptions.ForcedLoad | Config.LoadOptions.ProcessAttributes);
	}
	...
	class TestConfig: Config
	{
		...
		class CustomNonlinearSliderValue: Options.Components.NonlinearSliderValue
		{
